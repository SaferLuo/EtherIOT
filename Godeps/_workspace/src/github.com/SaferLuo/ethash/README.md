...
https://github.com/SaferLuo/wiki/wiki/Ethash

### Coding Style for C++ code:

Follow the same exact style as in [cpp-ethereum](https://github.com/SaferLuo/cpp-ethereum/blob/develop/CodingStandards.txt)
